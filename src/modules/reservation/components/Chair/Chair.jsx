 ...
 * Chair component
 *
 * Renders a chair with specified position, color, and rotation.
 *
 * @param {Object} props - The component props
 * @param {number} props.cx - The x-coordinate of the chair's center
 * @param {number} props.cy - The y-coordinate of the chair's center
 * @param {string} [props.color='#b5651d'] - The color of the chair
