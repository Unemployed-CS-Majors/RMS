                    ...
                    <>
                        <div className={styles.errorIcon}>
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M12 10.5C12.4142 10.5 12.75 10.8358 12.75 11.25V16.5C12.75 16.9142 12.4142 17.25 12 17.25C11.5858 17.25 11.25 16.9142 11.25 16.5V11.25C11.25 10.8358 11.5858 10.5 12 10.5Z" fill="currentColor"/>
                            </svg>
                        </div>
