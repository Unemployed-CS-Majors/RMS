          ...
          {editingAddress ? (
            <form onSubmit={saveAddress}>
              <div className={styles.formGroup}>
                ...
                />
                {validationErrors.street && <span className={styles.errorMessage}>{validationErrors.street}</span>}
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  placeholder='Dublin'
                />
                {validationErrors.city && <span className={styles.errorMessage}>{validationErrors.city}</span>}
              </div>
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <input
                    ...
                    placeholder='Dublin'
                  />
                  {validationErrors.county && <span className={styles.errorMessage}>{validationErrors.county}</span>}
                </div>
                ...
                <div className={styles.formGroup}>
                  ...
                  />
                  {validationErrors.eircode && <span className={styles.errorMessage}>{validationErrors.eircode}</span>}
                </div>
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  placeholder='Ireland'
                />
                {validationErrors.country && <span className={styles.errorMessage}>{validationErrors.country}</span>}
              </div>
            ...
            <div className={styles.infoDisplay}>
              {address.street ? (
                <>
                  <div className={styles.infoItem}>
                    <span className={styles.infoValue}>{address.street}</span>
                  </div>
                  <div className={styles.infoItem}>
            ...
            <form onSubmit={saveMap}>
              <div className={styles.formGroup}>
                ...
                <p className={styles.helpText}>
                  Paste the URL from the Google Maps embed code (src attribute). You can get this from Google Maps by
                  clicking "Share" and then "Embed a map".
                </p>
